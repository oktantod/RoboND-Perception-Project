...
def pcl_callback(pcl_msg):
    ...
    #filename = '/home/robond/catkin_ws/src/RoboND-Perception-Project/original_pcl.pcd'
    #pcl.save(pcl_msg, filename)
    ...
    #filename = '/home/robond/catkin_ws/src/RoboND-Perception-Project/voxel_downsampled.pcd'
    ...
    passthrough.set_filter_limits (axis_min, axis_max)
    cloud_filtered = passthrough.filter()
    #filename = '/home/robond/catkin_ws/src/RoboND-Perception-Project/pass_through_filtered.pcd'
    #pcl.save(cloud_filtered, filename)
    ...
    #filename = '/home/robond/catkin_ws/src/RoboND-Perception-Project/extracted_inliers.pcd'
    #pcl.save(extracted_inliers, filename)
    #filename = '/home/robond/catkin_ws/src/RoboND-Perception-Project/extracted_outliers.pcd'
    ...
    # TODO: Create a cluster extraction object
...
def pr2_mover(object_list):
    ...
    # TODO: Check consistency of detected objects list
    ...
    for target in object_list_param:
        ...
        if (found):
             ...
             rospy.loginfo("PICK_POSE (x,y,x) = (%f, %f, %f)", PICK_POSE.position.x, PICK_POSE.position.y, PICK_POSE.position.z)
    ...
    send_to_yaml("/home/robond/catkin_ws/src/RoboND-Perception-Project/output_" + str(TEST_SCENE_NUM.data) + ".yaml",output_yaml)
